...
* [lh_personalised_content loggedout="Hello guest"]the is %reset_url%[/lh_personalised_content] will display the users password reset url (via email) to the user and "hello guest" if the users email is not recognised
